...
<p><input type="checkbox" name="category" checked = "checked"/>写个c++项目</p>
...
<p><input type="checkbox" name="category"/>基础补充(计算机网络,操作系统,数据结构,算法...)</p>

<p><input type="checkbox" name="category"/>整合代码结构</p>

<p><input type="checkbox" name="category"/>软著申请</p>
<p><input type="checkbox" name="category"/>实习申请(字节,腾讯,阿里,华为)</p>
----
